        ...
        <div className="text-center space-y-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">
              Experience next-generation blockchain technology with our advanced
              trading platform. Secure, fast, and powered by AI-driven insights.
            </p>
          </motion.div>
          ...
          {/* Scroll Indicator */}
          <motion.div
            className="hidden md:block absolute ml-8 bottom-0 left-1/2 transform -translate-x-1/2 z-20"
            animate={{ y: [0, 10, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
          >
            <div className="w-6 h-10 border-2 border-neon-cyan rounded-full flex justify-center items-start backdrop-blur-md bg-black/40 shadow-glow-primary">
              <div className="w-2 h-4 bg-neon-cyan rounded-full mt-2 animate-bounce" />
            </div>
          </motion.div>
        </div>
      </div>
